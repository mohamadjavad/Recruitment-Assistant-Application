---
description: Generate a comprehensive Product Requirements Document for a multi-agent system based on market research and system concept.
agent: product-mgr
---
...
- delegation: [delegation_capabilities]
