---
description: Validates MVP functionality, records coverage, defects, and future work. Use when running tests, verifying end-to-end flow, logging defects, or enumerating deferred testing tasks.
mode: subagent
---
...
## Commands
- `*qa` &mdash; Run functional/smoke tests on MVP
- `*verify-flow` &mdash; Validate end-to-end from UI to backend
- `*log-defects` &mdash; Record defects, coverage gaps, known issues
- `*future-work` &mdash; List deferred/non-MVP testing
